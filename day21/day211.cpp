...
const int distKB[11][11] = {
    ...
    {DW+LF, 0, RG, 2*RG, UP, UP+RG, UP+2*RG, 2*UP, 2*UP+RG, 2*UP+2*RG, DW+2*LF}, //from 1
    {DW, LF, 0, RG, UP+LF, UP, UP+RG, 2*UP+LF, 2*UP, 2*UP+RG, DW+RG}, //from 2
    {DW+RG, 2*LF, LF, 0, UP+2*LF, UP+LF, UP, 2*UP+2*LF, 2*UP+LF, 2*UP, DW}, //from 3
    ...
    {2*DW+LF, DW+2*LF, 2*DW+LF, 2*DW, 2*LF, LF, 0, UP+2*LF, UP+LF, UP, 2*DW}, //from 6
    {3*DW+RG, 2*DW, 2*DW+RG, 2*DW+2*RG, DW, DW+RG, DW+2*RG, 0, RG, 2*RG, 3*DW+RG}, //from 7
...
const int distDIR[11][11] = {
    ...
    {UP+RG, RG, 0, 2*LF, 0, 0, 0, 0, 0, 0, UP+2*LF}, //from LFT
